...
The repository contains the production backend foundation, local PDF ingestion, hybrid retrieval, cross-encoder reranking, a bounded LangGraph adaptive retrieval planner, strict grounded generation through local Ollama/Qwen2.5, and independent citation/grounding verification with targeted evidence repair. Evaluation, streaming, and the frontend are intentionally not implemented yet.
