...
Milestone 2 adds a durable PDF ingestion pipeline. It intentionally does not expose retrieval, reranking, LangGraph query planning, answer generation, or RAG evaluation.
